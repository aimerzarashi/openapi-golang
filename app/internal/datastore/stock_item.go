...
func (q stockItemQuery) One(ctx context.Context, exec boil.ContextExecutor) (*StockItem, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "datastore: failed to execute a one query for stock_item")
	}
...
func (q stockItemQuery) All(ctx context.Context, exec boil.ContextExecutor) (StockItemSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "datastore: failed to assign all query results to StockItem slice")
	}
...
func (q stockItemQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "datastore: failed to count stock_item rows")
	}
...
func (q stockItemQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "datastore: failed to check if stock_item exists")
	}
...
func FindStockItem(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*StockItem, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "datastore: unable to select from stock_item")
	}
...
func (o *StockItem) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("datastore: no stock_item provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "datastore: unable to insert into stock_item")
	}
...
func (o *StockItem) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("datastore: unable to update stock_item, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "datastore: unable to update stock_item row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "datastore: failed to get rows affected by update for stock_item")
	}
...
func (q stockItemQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "datastore: unable to update all for stock_item")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "datastore: unable to retrieve rows affected for stock_item")
	}
...
func (o StockItemSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if len(cols) == 0 {
		return 0, errors.New("datastore: update all requires at least one column argument")
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "datastore: unable to update all in stockItem slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "datastore: unable to retrieve rows affected all in update all stockItem")
	}
	return rowsAff, nil
}
...
func (o *StockItem) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("datastore: no stock_item provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("datastore: unable to upsert stock_item, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "datastore: unable to upsert stock_item")
	}
...
func (o *StockItem) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("datastore: no StockItem provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "datastore: unable to delete from stock_item")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "datastore: failed to get rows affected by delete for stock_item")
	}
...
func (q stockItemQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("datastore: no stockItemQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "datastore: unable to delete all from stock_item")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "datastore: failed to get rows affected by deleteall for stock_item")
	}
...
func (o StockItemSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "datastore: unable to delete all from stockItem slice")
	}
...
func (o *StockItemSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "datastore: unable to reload all in StockItemSlice")
	}
...
func StockItemExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "datastore: unable to check if stock_item exists")
	}
